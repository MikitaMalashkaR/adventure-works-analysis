...
## Key Findings
- Bikes is the dominant revenue category at Adventure Works, generating over $23.6M — almost 95% of total revenue across 2015–2017.
- The United States and Australia are the top two markets, together generating over $15.5M — approximately 62% of total revenue.
- European markets (United Kingdom, Germany, France) collectively contribute around $7.5M, with each country showing comparable performance between $2M and $3M.
...
- Sales follow a clear seasonal pattern: Spring generates the highest revenue ($8.2M), followed by Winter ($6.8M), suggesting that customers purchase bikes in advance of the active cycling season.
